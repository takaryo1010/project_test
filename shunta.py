...
def main():                       #メイン:ゲームの動き全般はここ
    ...
    while roop==1:
        ...
        elif 20 < player.hp <= 50:
            screen.blit(img_gauge_yellow,(1040,45))
        elif player.hp <= 20:
            screen.blit(img_gauge_red,(1040,45))

        pygame.draw.rect(screen,(0,0,0),[(520+player.hp)*2,45,(100-player.hp)*2,20])    #ダメージを受けたら矩形で塗りつぶす 
...
def gameover():                                    #ゲームオーバーになったとき
    ...
    while True:
        ...
        screen.blit(keyboard_image,(160,100))
        screen.blit(player_image,rect_player.center)
        pygame.draw.rect(screen,(0,0,0),[(520+player.hp)*2,45,(100-player.hp)*2,20])
        #これから時間表示する
