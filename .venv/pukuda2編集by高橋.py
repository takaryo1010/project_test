...
class Enemy(Mob): #敵のクラス
    def __init__(self, x, y, hp, attack,speed, various):
        super().__init__(x, y, hp, attack)
        self.speed = speed
...
class Field:
    ...
    def append_sleep(self):
        ...
        if enemy_choice==0:
            self.enemys.append(Enemy(x, y, hp=100, attack=50, speed=1,various=0))
        elif enemy_choice==1:
            self.enemys.append(Enemy(x, y, hp=10, attack=10, speed=2.5, various=1))
        elif enemy_choice==2:
            self.enemys.append(Enemy(x, y, hp=10, attack=5, speed=4, various=2))
